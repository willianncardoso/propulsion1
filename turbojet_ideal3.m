...
M0   = 0:0.1:3;           %varredura em M0
pi_c = [1;2;3;5;10;20;30];%pi_c CONJUNTO FECHADO ()

j = length(pi_c);%cada linha do gr?fico CONJUNTO FECHADO
n = length(M0);
%-------------------------------------------------------------------------%
...
%       s      = |(mg/s)/N| consumo especifico de combustivel por empuxo
